...
module.exports = jQuery;}, "gfx/index": function(exports, require, module) {module.exports = require('./lib/gfx');}, "gfx/lib/gfx": function(exports, require, module) {(function() {
  ...
  var $, Contact, Contacts, ContactsCreate, ContactsList, ContactsShow, Panel, Spine;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  ContactsShow = (function() {
    __extends(ContactsShow, Panel);
    ContactsShow.prototype.className = 'contacts showView';
    function ContactsShow() {
      this.render = __bind(this.render, this);      ContactsShow.__super__.constructor.apply(this, arguments);
    ...
    ContactsShow.prototype.render = function() {
      ...
      return this.html(require('views/contacts/show')(this.item));
    };
    ContactsShow.prototype.change = function(params) {
      this.item = Contact.find(params.id);
      return this.render();
    };
    ContactsShow.prototype.back = function() {
  ...
  ContactsCreate = (function() {
    __extends(ContactsCreate, Panel);
    ContactsCreate.prototype.elements = {
      'form': 'form'
    };
    ContactsCreate.prototype.events = {
      'submit form': 'submit'
    };
    ContactsCreate.prototype.className = 'contacts createView';
    function ContactsCreate() {
      ContactsCreate.__super__.constructor.apply(this, arguments);
      this.addButton('Cancel', this.back);
      this.addButton('Create', this.submit).addClass('right');
      this.active(this.render);
    }
    ContactsCreate.prototype.render = function() {
      return this.html(require('views/contacts/form')());
    };
    ContactsCreate.prototype.submit = function(e) {
      var contact;
      e.preventDefault();
      contact = Contact.fromForm(this.form);
      if (contact.save()) {
        return this.navigate('/contacts', contact.id, {
          trans: 'left'
        });
      }
    };
    ContactsCreate.prototype.back = function() {
      return this.navigate('/contacts', {
        trans: 'left'
      });
    };
    ContactsCreate.prototype.deactivate = function() {
      ContactsCreate.__super__.deactivate.apply(this, arguments);
      return this.form.blur();
    };
    return ContactsCreate;
  })();
  ContactsList = (function() {
    __extends(ContactsList, Panel);
    ContactsList.prototype.events = {
      'tap .item': 'click'
    };
    ContactsList.prototype.title = 'Contacts';
    ContactsList.prototype.className = 'contacts list listView';
    function ContactsList() {
      this.render = __bind(this.render, this);      ContactsList.__super__.constructor.apply(this, arguments);
      Contact.bind('refresh change', this.render);
      this.addButton('Add', this.add).addClass('right');
    }
    ContactsList.prototype.render = function() {
      var items;
      items = Contact.all().sort(Contact.nameSort);
      return this.html(require('views/contacts/item')(items));
    };
    ContactsList.prototype.click = function(e) {
      var item;
      item = $(e.target).item();
    ...
    ContactsList.prototype.add = function() {
      return this.navigate('/contacts/create', {
        trans: 'right'
      });
    };
    return ContactsList;
  ...
  Contacts = (function() {
    ...
    function Contacts() {
      ...
      this.list = new ContactsList;
      this.show = new ContactsShow;
      this.create = new ContactsCreate;
      this.routes({
        '/contacts/create': function(params) {
          return this.create.active(params);
        },
        '/contacts/:id': function(params) {
          return this.show.active(params);
        },
  ...
  Contact = (function() {
    ...
    Contact.configure('Contact', 'email', 'name');
    Contact.extend(Contact.Local);
...
}, "views/contacts/form": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  ...
  return __out.join('');
}}, "views/contacts/item": function(exports, require, module) {module.exports = function(values){ 
  var $  = jQuery, result = $();
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize(this.name || this.email));
      __out.push('\n</div>');
    }).call(this);
  ...
  return result;
};}, "views/contacts/show": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
